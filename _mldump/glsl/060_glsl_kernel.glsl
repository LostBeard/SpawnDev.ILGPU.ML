...
void main() {
    ...
    bool v_16 = i64_ge(v_6, v_15);
    uvec2 v_17;
    v_17 = uvec2(2147483647u, 0u);
    bool v_18 = i64_le(v_6, v_17);
    bool v_19 = v_16 && v_18;
    // String: 32-bit index out of range
    int v_20 = i64_to_i32(v_6);
    int v_21;
    v_21 = int(0);
    bool v_22 = _idx >= v_21;
    bool v_23 = _idx < v_20;
    ...
    bool v_40 = i64_ge(v_4, v_39);
    uvec2 v_41;
    v_41 = uvec2(2147483647u, 0u);
    bool v_42 = i64_le(v_4, v_41);
    bool v_43 = v_40 && v_42;
    // String: 32-bit index out of range
    int v_44 = i64_to_i32(v_4);
    int v_45;
    v_45 = int(0);
    bool v_46 = v_38 >= v_45;
    bool v_47 = v_38 < v_44;
    ...
    bool v_54 = v_48 || v_53;
    // String: X index out of bounds
    int v_55 = int(v_38); // LEA into param1
    float v_56;
    v_56 = float(texelFetch(u_param1, ivec2((int(v_55) + u_param1_offset) % u_param1_tileW, (int(v_55) + u_param1_offset) / u_param1_tileW), 0).r);
    tf_out_2 = v_56;
}
