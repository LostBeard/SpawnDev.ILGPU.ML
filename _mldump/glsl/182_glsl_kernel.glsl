...
float fn_RoundToEven_230_411295(float p_0) {
    float v_0;
    v_0 = float(0.0);
    return 0.0;
}
...
void main() {
    ...
    float v_43 = 0.0;
    float v_44 = 0.0;
    // v_45 = buffer alias for param1
    v_2 = uvec2(0u);
    // v_46 = buffer alias for param2
    v_3 = uvec2(0u);
    ...
    int v_47 = int(_idx); // LEA into param2
    v_20 = uvec2(2147483648u, 4294967295u);
    v_21 = i64_ge(v_2, v_20);
    v_22 = uvec2(2147483647u, 0u);
    v_23 = i64_le(v_2, v_22);
    v_24 = v_21 && v_23;
    // String: 32-bit index out of range
    v_25 = i64_to_i32(v_2);
    v_26 = int(0);
    ...
    v_36 = float(texelFetch(u_param1, ivec2((int(v_48) + u_param1_offset) % u_param1_tileW, (int(v_48) + u_param1_offset) / u_param1_tileW), 0).r);
    v_37 = float(abs(v_36));
    v_38 = float(10000000.0);
    v_39 = v_37 >= v_38;
    v_44 = v_36;
    if (v_39) {
    } else {
