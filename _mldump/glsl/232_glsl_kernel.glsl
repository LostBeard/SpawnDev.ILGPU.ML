...
// Time: 2026-03-24T00:44:51.8190000Z
...
void main() {
    ...
    int v_96 = 0;
    int v_97 = 0;
    // v_98 = buffer alias for param1
    v_7 = uvec2(0u);
    // v_99 = buffer alias for param2
    v_8 = uvec2(0u);
    // v_100 = buffer alias for param3
    v_9 = uvec2(0u);
    // v_101 = buffer alias for param4
    v_10 = uvec2(0u);
    v_11 = _idx / v_6;
    v_12 = _idx % v_6;
    v_13 = float(0.0);
    ...
    for (int _loop0 = 0; _loop0 < 100000; _loop0++) {
        ...
        int v_102 = int(v_73); // LEA into param1
        v_82 = float(texelFetch(u_param1, ivec2((int(v_102) + u_param1_offset) % u_param1_tileW, (int(v_102) + u_param1_offset) / u_param1_tileW), 0).r);
        v_83 = v_32 * v_6;
        v_84 = v_83 + v_12;
        // String: 32-bit index out of range
        v_85 = int(0);
        ...
        v_92 = v_88 || v_91;
        // String: X index out of bounds
        int v_103 = int(v_84); // LEA into param2
        v_93 = float(texelFetch(u_param2, ivec2((int(v_103) + u_param2_offset) % u_param2_tileW, (int(v_103) + u_param2_offset) / u_param2_tileW), 0).r);
        v_94 = v_82 * v_93;
        v_95 = v_33 + v_94;
        v_96 = int(1);
        v_97 = v_32 + v_96;
    ...
    v_50 = v_44 || v_49;
    // String: X index out of bounds
    int v_104 = int(v_12); // LEA into param3
    v_51 = float(texelFetch(u_param3, ivec2((int(v_104) + u_param3_offset) % u_param3_tileW, (int(v_104) + u_param3_offset) / u_param3_tileW), 0).r);
    v_52 = v_33 + v_51;
    v_53 = uvec2(2147483648u, 4294967295u);
    v_54 = i64_ge(v_10, v_53);
    v_55 = uvec2(2147483647u, 0u);
    v_56 = i64_le(v_10, v_55);
    v_57 = v_54 && v_56;
    // String: 32-bit index out of range
    v_58 = i64_to_i32(v_10);
    v_59 = int(0);
    v_60 = _idx >= v_59;
    v_61 = _idx < v_58;
    v_62 = v_60 && v_61;
    ...
    v_68 = v_62 || v_67;
    // String: X index out of bounds
    int v_105 = int(_idx); // LEA into param4
    v_69 = float(0.0);
    v_70 = v_52 > v_69;
    v_71 = float(0.0);
    v_72 = v_70 ? v_52 : v_71;
