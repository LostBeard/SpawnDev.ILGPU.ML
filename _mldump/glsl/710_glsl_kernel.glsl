...
// Time: 2026-03-24T00:45:18.8380000Z
...
void main() {
    ...
    bool v_25 = i64_ge(v_5, v_24);
    uvec2 v_26;
    v_26 = uvec2(2147483647u, 0u);
    bool v_27 = i64_le(v_5, v_26);
    bool v_28 = v_25 && v_27;
    // String: 32-bit index out of range
    int v_29 = i64_to_i32(v_5);
    int v_30;
    v_30 = int(0);
    bool v_31 = _idx >= v_30;
    bool v_32 = _idx < v_29;
    ...
    bool v_39 = v_33 || v_38;
    // String: X index out of bounds
    int v_40 = int(_idx); // LEA into param2
    float v_41;
    v_41 = float(texelFetch(u_param2, ivec2((int(v_40) + u_param2_offset) % u_param2_tileW, (int(v_40) + u_param2_offset) / u_param2_tileW), 0).r);
    float v_42 = v_23 + v_41;
    tf_out_1 = v_42;
}
