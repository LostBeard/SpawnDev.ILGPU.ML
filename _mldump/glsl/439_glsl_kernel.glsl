...
// Time: 2026-03-24T00:45:06.9390000Z
...
void main() {
    ...
    int v_73 = 0;
    int v_74 = 0;
    // v_75 = buffer alias for param1
    v_6 = uvec2(0u);
    // v_76 = buffer alias for param2
    v_7 = uvec2(0u);
    // v_77 = buffer alias for param3
    v_8 = uvec2(0u);
    v_9 = _idx % v_5;
    v_10 = _idx / v_5;
    v_11 = v_10 < v_3;
    if (v_11) {
        ...
        for (int _loop0 = 0; _loop0 < 100000; _loop0++) {
            ...
            int v_78 = int(v_50); // LEA into param1
            v_59 = float(texelFetch(u_param1, ivec2((int(v_78) + u_param1_offset) % u_param1_tileW, (int(v_78) + u_param1_offset) / u_param1_tileW), 0).r);
            v_60 = v_32 * v_5;
            v_61 = v_60 + v_9;
            // String: 32-bit index out of range
            v_62 = int(0);
            ...
            v_69 = v_65 || v_68;
            // String: X index out of bounds
            int v_79 = int(v_61); // LEA into param2
            v_70 = float(texelFetch(u_param2, ivec2((int(v_79) + u_param2_offset) % u_param2_tileW, (int(v_79) + u_param2_offset) / u_param2_tileW), 0).r);
            v_71 = v_59 * v_70;
            v_72 = v_31 + v_71;
            v_73 = int(1);
            v_74 = v_32 + v_73;
        ...
        v_35 = i64_ge(v_8, v_34);
        v_36 = uvec2(2147483647u, 0u);
        v_37 = i64_le(v_8, v_36);
        v_38 = v_35 && v_37;
        // String: 32-bit index out of range
        v_39 = i64_to_i32(v_8);
        v_40 = int(0);
        ...
        v_49 = v_43 || v_48;
        // String: X index out of bounds
        int v_80 = int(_idx); // LEA into param3
        tf_out_3 = v_31;
    } else {
    }
    return;
