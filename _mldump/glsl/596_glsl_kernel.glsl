...
// Time: 2026-03-24T00:45:15.9270000Z
...
void main() {
    ...
    bool v_8 = i64_ge(v_4, v_7);
    uvec2 v_9;
    v_9 = uvec2(2147483647u, 0u);
    bool v_10 = i64_le(v_4, v_9);
    bool v_11 = v_8 && v_10;
    // String: 32-bit index out of range
    int v_12 = i64_to_i32(v_4);
    int v_13;
    v_13 = int(0);
    bool v_14 = _idx >= v_13;
    bool v_15 = _idx < v_12;
    ...
    int v_23 = int(_idx); // LEA into param1
    float v_24;
    v_24 = float(texelFetch(u_param1, ivec2((int(v_23) + u_param1_offset) % u_param1_tileW, (int(v_23) + u_param1_offset) / u_param1_tileW), 0).r);
    int v_25 = _idx % v_2;
    uvec2 v_26;
    v_26 = uvec2(2147483648u, 4294967295u);
    bool v_27 = i64_ge(v_6, v_26);
    uvec2 v_28;
    v_28 = uvec2(2147483647u, 0u);
    bool v_29 = i64_le(v_6, v_28);
    bool v_30 = v_27 && v_29;
    // String: 32-bit index out of range
    int v_31 = i64_to_i32(v_6);
    int v_32;
    v_32 = int(0);
    bool v_33 = v_25 >= v_32;
    bool v_34 = v_25 < v_31;
    ...
    bool v_41 = v_35 || v_40;
    // String: X index out of bounds
    int v_42 = int(v_25); // LEA into param2
    float v_43;
    v_43 = float(texelFetch(u_param2, ivec2((int(v_42) + u_param2_offset) % u_param2_tileW, (int(v_42) + u_param2_offset) / u_param2_tileW), 0).r);
    float v_44 = v_24 + v_43;
    tf_out_1 = v_44;
}
