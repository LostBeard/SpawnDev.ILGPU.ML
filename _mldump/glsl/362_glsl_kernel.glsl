...
// Time: 2026-03-24T00:44:56.8850000Z
...
void main() {
    ...
    uvec2 v_3 = uvec2(0u);
    // v_4 = buffer alias for param2
    uvec2 v_5 = uvec2(0u);
    uvec2 v_6;
    v_6 = uvec2(2147483648u, 4294967295u);
    bool v_7 = i64_ge(v_3, v_6);
    uvec2 v_8;
    v_8 = uvec2(2147483647u, 0u);
    bool v_9 = i64_le(v_3, v_8);
    bool v_10 = v_7 && v_9;
    // String: 32-bit index out of range
    int v_11 = i64_to_i32(v_3);
    int v_12;
    v_12 = int(0);
    bool v_13 = _idx >= v_12;
    bool v_14 = _idx < v_11;
    ...
    int v_22 = int(_idx); // LEA into param1
    float v_23;
    v_23 = float(texelFetch(u_param1, ivec2((int(v_22) + u_param1_offset) % u_param1_tileW, (int(v_22) + u_param1_offset) / u_param1_tileW), 0).r);
    float v_24;
    v_24 = float(0.0);
    bool v_25 = v_23 < v_24;
    float v_26;
    ...
    v_28 = float(1.0);
    float v_29;
    v_29 = float(0.327591091);
    float v_30 = v_27 * v_29;
    float v_31 = v_30 + v_28;
    float v_32;
    v_32 = float(1.0 / v_31);
    float v_33 = v_32 * v_32;
    float v_34 = v_33 * v_32;
    float v_35 = v_34 * v_32;
    float v_36 = v_35 * v_32;
    float v_37;
    v_37 = float(1.0);
    float v_38;
    v_38 = float(0.254829586);
    float v_39 = v_32 * v_38;
    float v_40;
    v_40 = float(-0.284496725);
    float v_41 = v_33 * v_40;
    float v_42 = v_39 + v_41;
    float v_43;
    v_43 = float(1.42141378);
    float v_44 = v_34 * v_43;
    float v_45 = v_42 + v_44;
    float v_46;
    v_46 = float(-1.45315206);
    float v_47 = v_35 * v_46;
    float v_48 = v_45 + v_47;
    float v_49;
    v_49 = float(1.06140542);
    float v_50 = v_36 * v_49;
    float v_51 = v_48 + v_50;
    float v_52;
    v_52 = float(-v_27);
    float v_53 = v_52 * v_27;
    float v_54;
    v_54 = float(exp(v_53));
    float v_55 = v_51 * v_54;
    float v_56 = v_37 - v_55;
    uvec2 v_57;
    v_57 = uvec2(2147483648u, 4294967295u);
    bool v_58 = i64_ge(v_5, v_57);
    uvec2 v_59;
    v_59 = uvec2(2147483647u, 0u);
    bool v_60 = i64_le(v_5, v_59);
    bool v_61 = v_58 && v_60;
    // String: 32-bit index out of range
    int v_62 = i64_to_i32(v_5);
    int v_63;
    v_63 = int(0);
    bool v_64 = _idx >= v_63;
    bool v_65 = _idx < v_62;
    ...
    bool v_72 = v_66 || v_71;
    // String: X index out of bounds
    int v_73 = int(_idx); // LEA into param2
    float v_74;
    v_74 = float(0.0);
    bool v_75 = v_23 < v_74;
    float v_76;
