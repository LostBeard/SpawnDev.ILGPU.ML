...
// Time: 2026-03-24T00:44:50.5370000Z
...
uniform highp isampler2D u_param2; // buffer param[2]
...
void main() {
    ...
    bool v_14 = i64_ge(v_8, v_13);
    uvec2 v_15;
    v_15 = uvec2(2147483647u, 0u);
    bool v_16 = i64_le(v_8, v_15);
    bool v_17 = v_14 && v_16;
    // String: 32-bit index out of range
    int v_18 = i64_to_i32(v_8);
    int v_19;
    v_19 = int(0);
    bool v_20 = v_11 >= v_19;
    bool v_21 = v_11 < v_18;
    ...
    int v_29 = int(v_11); // LEA into param2
    int v_30;
    v_30 = int(texelFetch(u_param2, ivec2((int(v_29) + u_param2_offset) % u_param2_tileW, (int(v_29) + u_param2_offset) / u_param2_tileW), 0).r);
    uvec2 v_31;
    v_31 = uvec2(2147483648u, 4294967295u);
    bool v_32 = i64_ge(v_10, v_31);
    uvec2 v_33;
    v_33 = uvec2(2147483647u, 0u);
    bool v_34 = i64_le(v_10, v_33);
    bool v_35 = v_32 && v_34;
    // String: 32-bit index out of range
    int v_36 = i64_to_i32(v_10);
    int v_37;
    v_37 = int(0);
    bool v_38 = _idx >= v_37;
    bool v_39 = _idx < v_36;
    ...
    bool v_46 = v_40 || v_45;
    // String: X index out of bounds
    int v_47 = int(_idx); // LEA into param3
    int v_48 = v_30 * v_3;
    int v_49 = v_48 + v_12;
    uvec2 v_50;
    v_50 = uvec2(2147483648u, 4294967295u);
    bool v_51 = i64_ge(v_6, v_50);
    uvec2 v_52;
    v_52 = uvec2(2147483647u, 0u);
    bool v_53 = i64_le(v_6, v_52);
    bool v_54 = v_51 && v_53;
    // String: 32-bit index out of range
    int v_55 = i64_to_i32(v_6);
    int v_56;
    v_56 = int(0);
    bool v_57 = v_49 >= v_56;
    bool v_58 = v_49 < v_55;
    ...
    bool v_65 = v_59 || v_64;
    // String: X index out of bounds
    int v_66 = int(v_49); // LEA into param1
    float v_67;
    v_67 = float(texelFetch(u_param1, ivec2((int(v_66) + u_param1_offset) % u_param1_tileW, (int(v_66) + u_param1_offset) / u_param1_tileW), 0).r);
    tf_out_3 = v_67;
}
