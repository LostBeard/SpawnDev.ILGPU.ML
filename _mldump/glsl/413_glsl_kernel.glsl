...
// Time: 2026-03-24T00:44:58.2440000Z
...
void main() {
    ...
    int v_47 = int(_idx); // LEA into param1
    v_20 = float(texelFetch(u_param1, ivec2((int(v_47) + u_param1_offset) % u_param1_tileW, (int(v_47) + u_param1_offset) / u_param1_tileW), 0).r);
    v_21 = uvec2(2147483648u, 4294967295u);
    v_22 = i64_ge(v_3, v_21);
    v_23 = uvec2(2147483647u, 0u);
    v_24 = i64_le(v_3, v_23);
    v_25 = v_22 && v_24;
    // String: 32-bit index out of range
    v_26 = i64_to_i32(v_3);
    v_27 = int(0);
    ...
    v_36 = v_30 || v_35;
    // String: X index out of bounds
    int v_48 = int(_idx); // LEA into param2
    v_37 = float(80.0);
    v_38 = v_20 > v_37;
    if (v_38) {
        v_43 = float(3.402823e+38);
        v_44 = v_43;
    } else {
        v_39 = float(-80.0);
        v_40 = v_20 < v_39;
