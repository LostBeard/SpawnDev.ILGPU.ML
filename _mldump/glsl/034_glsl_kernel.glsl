...
uniform highp float u_param3; // scalar param[3]
...
void main() {
    ...
    bool v_8 = i64_ge(v_6, v_7);
    uvec2 v_9;
    v_9 = uvec2(2147483647u, 0u);
    bool v_10 = i64_le(v_6, v_9);
    bool v_11 = v_8 && v_10;
    // String: 32-bit index out of range
    int v_12 = i64_to_i32(v_6);
    int v_13;
    v_13 = int(0);
    bool v_14 = _idx >= v_13;
    bool v_15 = _idx < v_12;
    ...
    int v_23 = int(_idx); // LEA into param2
    uvec2 v_24;
    v_24 = uvec2(2147483648u, 4294967295u);
    bool v_25 = i64_ge(v_4, v_24);
    uvec2 v_26;
    v_26 = uvec2(2147483647u, 0u);
    bool v_27 = i64_le(v_4, v_26);
    bool v_28 = v_25 && v_27;
    // String: 32-bit index out of range
    int v_29 = i64_to_i32(v_4);
    int v_30;
    v_30 = int(0);
    bool v_31 = _idx >= v_30;
    bool v_32 = _idx < v_29;
    ...
    bool v_39 = v_33 || v_38;
    // String: X index out of bounds
    int v_40 = int(_idx); // LEA into param1
    float v_41;
    v_41 = float(texelFetch(u_param1, ivec2((int(v_40) + u_param1_offset) % u_param1_tileW, (int(v_40) + u_param1_offset) / u_param1_tileW), 0).r);
    float v_42 = v_41 * v_2;
    tf_out_2 = v_42;
}
