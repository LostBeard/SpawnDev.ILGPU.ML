...
// Time: 2026-03-24T00:44:30.5100000Z
...
void main() {
    ...
    int v_49 = int(_idx); // LEA into param1
    v_18 = float(texelFetch(u_param1, ivec2((int(v_49) + u_param1_offset) % u_param1_tileW, (int(v_49) + u_param1_offset) / u_param1_tileW), 0).r);
    v_19 = float(6.0);
    v_20 = v_18 / v_19;
    v_21 = float(0.5);
    v_22 = v_20 + v_21;
    ...
    v_32 = i64_ge(v_1, v_31);
    v_33 = uvec2(2147483647u, 0u);
    v_34 = i64_le(v_1, v_33);
    v_35 = v_32 && v_34;
    // String: 32-bit index out of range
    v_36 = i64_to_i32(v_1);
    v_37 = int(0);
