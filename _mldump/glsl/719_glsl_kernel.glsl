...
// Time: 2026-03-24T00:45:19.4600000Z
...
void main() {
    ...
    for (int _loop0 = 0; _loop0 < 100000; _loop0++) {
        ...
        int v_59 = int(v_44); // LEA into param1
        v_53 = float(texelFetch(u_param1, ivec2((int(v_59) + u_param1_offset) % u_param1_tileW, (int(v_59) + u_param1_offset) / u_param1_tileW), 0).r);
        v_54 = v_23 + v_53;
        v_55 = int(1);
        v_56 = v_22 + v_55;
        v_22 = v_56;
