...
// Time: 2026-03-24T00:45:10.5190000Z
...
void main() {
    ...
    float v_67 = 0.0;
    float v_68 = 0.0;
    // v_69 = buffer alias for param1
    v_5 = uvec2(0u);
    // v_70 = buffer alias for param2
    v_6 = uvec2(0u);
    // v_71 = buffer alias for param3
    v_7 = uvec2(0u);
    v_8 = int(1);
    v_9 = v_4 << v_8;
    v_10 = _idx / v_9;
    ...
    v_13 = i64_ge(v_7, v_12);
    v_14 = uvec2(2147483647u, 0u);
    v_15 = i64_le(v_7, v_14);
    v_16 = v_13 && v_15;
    ...
    int v_72 = int(_idx); // LEA into param3
    v_28 = v_11 < v_4;
    if (v_28) {
        v_49 = v_10 * v_4;
        v_50 = v_49 + v_11;
        v_51 = uvec2(2147483648u, 4294967295u);
        v_52 = i64_ge(v_5, v_51);
        v_53 = uvec2(2147483647u, 0u);
        v_54 = i64_le(v_5, v_53);
        v_55 = v_52 && v_54;
        // String: 32-bit index out of range
        v_56 = i64_to_i32(v_5);
        v_57 = int(0);
        ...
        v_66 = v_60 || v_65;
        // String: X index out of bounds
        int v_73 = int(v_50); // LEA into param1
        v_67 = float(texelFetch(u_param1, ivec2((int(v_73) + u_param1_offset) % u_param1_tileW, (int(v_73) + u_param1_offset) / u_param1_tileW), 0).r);
        v_68 = v_67;
    } else {
        v_29 = v_10 * v_4;
        v_30 = v_11 - v_4;
        ...
        v_33 = i64_ge(v_6, v_32);
        v_34 = uvec2(2147483647u, 0u);
        v_35 = i64_le(v_6, v_34);
        v_36 = v_33 && v_35;
        // String: 32-bit index out of range
        v_37 = i64_to_i32(v_6);
        v_38 = int(0);
        ...
        v_47 = v_41 || v_46;
        // String: X index out of bounds
        int v_74 = int(v_31); // LEA into param2
        v_48 = float(texelFetch(u_param2, ivec2((int(v_74) + u_param2_offset) % u_param2_tileW, (int(v_74) + u_param2_offset) / u_param2_tileW), 0).r);
        v_68 = v_48;
    }
    tf_out_3 = v_68;
    return;
