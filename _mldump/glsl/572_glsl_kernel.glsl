...
// Time: 2026-03-24T00:45:14.5260000Z
...
void main() {
    ...
    int v_45 = int(_idx); // LEA into param2
    if (v_8) {
        v_42 = v_2;
    } else {
        v_25 = uvec2(2147483648u, 4294967295u);
        v_26 = i64_ge(v_3, v_25);
        v_27 = uvec2(2147483647u, 0u);
        v_28 = i64_le(v_3, v_27);
        v_29 = v_26 && v_28;
        // String: 32-bit index out of range
        v_30 = i64_to_i32(v_3);
        v_31 = int(0);
        ...
        v_41 = float(texelFetch(u_param1, ivec2((int(v_46) + u_param1_offset) % u_param1_tileW, (int(v_46) + u_param1_offset) / u_param1_tileW), 0).r);
        v_42 = v_41;
    }
    tf_out_2 = v_42;
    return;
