...
// Time: 2026-03-24T00:45:12.9030000Z
...
void main() {
    ...
    int v_49 = 0;
    int v_50 = 0;
    // v_51 = buffer alias for param1
    v_4 = uvec2(0u);
    // v_52 = buffer alias for param2
    v_5 = uvec2(0u);
    v_6 = float(0.0);
    v_7 = _idx * v_2;
    v_8 = int(0);
    ...
    for (int _loop0 = 0; _loop0 < 100000; _loop0++) {
        ...
        int v_53 = int(v_38); // LEA into param1
        v_47 = float(texelFetch(u_param1, ivec2((int(v_53) + u_param1_offset) % u_param1_tileW, (int(v_53) + u_param1_offset) / u_param1_tileW), 0).r);
        v_48 = v_17 + v_47;
        v_49 = int(1);
        v_50 = v_18 + v_49;
        v_17 = v_48;
    ...
    v_35 = v_29 || v_34;
    // String: X index out of bounds
    int v_54 = int(_idx); // LEA into param2
    v_36 = float(v_2);
    v_37 = v_17 / v_36;
    tf_out_2 = v_37;
    return;
