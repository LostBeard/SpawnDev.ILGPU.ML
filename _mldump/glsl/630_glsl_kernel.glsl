...
// Time: 2026-03-24T00:45:16.7820000Z
...
void main() {
    ...
    // v_3 = buffer alias for param1
    uvec2 v_4 = uvec2(0u);
    // v_5 = buffer alias for param2
    uvec2 v_6 = uvec2(0u);
    // v_7 = buffer alias for param3
    uvec2 v_8 = uvec2(0u);
    uvec2 v_9;
    v_9 = uvec2(2147483648u, 4294967295u);
    bool v_10 = i64_ge(v_8, v_9);
    uvec2 v_11;
    v_11 = uvec2(2147483647u, 0u);
    bool v_12 = i64_le(v_8, v_11);
    bool v_13 = v_10 && v_12;
    // String: 32-bit index out of range
    int v_14 = i64_to_i32(v_8);
    int v_15;
    v_15 = int(0);
    bool v_16 = _idx >= v_15;
    bool v_17 = _idx < v_14;
    ...
    int v_25 = int(_idx); // LEA into param3
    uvec2 v_26;
    v_26 = uvec2(2147483648u, 4294967295u);
    bool v_27 = i64_ge(v_4, v_26);
    uvec2 v_28;
    v_28 = uvec2(2147483647u, 0u);
    bool v_29 = i64_le(v_4, v_28);
    bool v_30 = v_27 && v_29;
    // String: 32-bit index out of range
    int v_31 = i64_to_i32(v_4);
    int v_32;
    v_32 = int(0);
    bool v_33 = _idx >= v_32;
    bool v_34 = _idx < v_31;
    ...
    bool v_41 = v_35 || v_40;
    // String: X index out of bounds
    int v_42 = int(_idx); // LEA into param1
    float v_43;
    v_43 = float(texelFetch(u_param1, ivec2((int(v_42) + u_param1_offset) % u_param1_tileW, (int(v_42) + u_param1_offset) / u_param1_tileW), 0).r);
    uvec2 v_44;
    ...
    float v_61;
    v_61 = float(texelFetch(u_param2, ivec2((int(v_60) + u_param2_offset) % u_param2_tileW, (int(v_60) + u_param2_offset) / u_param2_tileW), 0).r);
    float v_62 = pow(v_43, v_61);
    tf_out_3 = v_62;
}
