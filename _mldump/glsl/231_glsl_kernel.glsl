...
// Time: 2026-03-24T00:44:51.5280000Z
...
void main() {
    ...
    int v_23;
    v_23 = int(texelFetch(u_param1, ivec2((int(v_22) + u_param1_offset) % u_param1_tileW, (int(v_22) + u_param1_offset) / u_param1_tileW), 0).r);
    int v_24;
    v_24 = int(255);
    int v_25 = v_23 & v_24;
    float v_26 = float(v_25);
    float v_27;
    v_27 = float(255.0);
    ...
    v_38 = int(255);
    int v_39 = v_37 & v_38;
    float v_40 = float(v_39);
    float v_41;
    v_41 = float(255.0);
    float v_42 = v_40 / v_41;
    uvec2 v_43;
    v_43 = uvec2(2147483648u, 4294967295u);
    bool v_44 = i64_ge(v_5, v_43);
    uvec2 v_45;
    v_45 = uvec2(2147483647u, 0u);
    bool v_46 = i64_le(v_5, v_45);
    bool v_47 = v_44 && v_46;
    // String: 32-bit index out of range
    int v_48 = i64_to_i32(v_5);
    int v_49;
    v_49 = int(0);
    bool v_50 = _idx >= v_49;
    bool v_51 = _idx < v_48;
    ...
    bool v_58 = v_52 || v_57;
    // String: X index out of bounds
    int v_59 = int(_idx); // LEA into param2
    float v_60;
    v_60 = float(0.212599993);
    float v_61 = v_28 * v_60;
    float v_62;
    v_62 = float(0.715200007);
    float v_63 = v_35 * v_62;
    float v_64 = v_61 + v_63;
    float v_65;
    v_65 = float(0.0722000003);
    float v_66 = v_42 * v_65;
    float v_67 = v_64 + v_66;
    tf_out_2 = v_67;
}
