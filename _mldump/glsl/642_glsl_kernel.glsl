...
void main() {
    ...
    bool v_41 = false;
    bool v_42 = false;
    // v_43 = buffer alias for param1
    v_4 = uvec2(0u);
    // v_44 = buffer alias for param2
    v_5 = uvec2(0u);
    ...
    int v_45 = int(_idx); // LEA into param1
    v_22 = float(texelFetch(u_param1, ivec2((int(v_45) + u_param1_offset) % u_param1_tileW, (int(v_45) + u_param1_offset) / u_param1_tileW), 0).r);
    v_23 = v_22 >= v_2;
    v_24 = v_22;
    if (v_23) {
    } else {
    ...
    v_42 = v_36 || v_41;
    // String: X index out of bounds
    int v_46 = int(_idx); // LEA into param2
    tf_out_2 = v_26;
    return;
}
