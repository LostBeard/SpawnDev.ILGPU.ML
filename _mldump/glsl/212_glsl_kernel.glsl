...
// Time: 2026-03-24T00:44:50.3120000Z
...
void main() {
    ...
    int v_92 = 0;
    int v_93 = 0;
    // v_94 = buffer alias for param1
    v_7 = uvec2(0u);
    // v_95 = buffer alias for param2
    v_8 = uvec2(0u);
    // v_96 = buffer alias for param3
    v_9 = uvec2(0u);
    // v_97 = buffer alias for param4
    v_10 = uvec2(0u);
    v_11 = _idx / v_6;
    v_12 = _idx % v_6;
    v_13 = float(0.0);
    ...
    for (int _loop0 = 0; _loop0 < 100000; _loop0++) {
        ...
        int v_98 = int(v_69); // LEA into param1
        v_78 = float(texelFetch(u_param1, ivec2((int(v_98) + u_param1_offset) % u_param1_tileW, (int(v_98) + u_param1_offset) / u_param1_tileW), 0).r);
        v_79 = v_32 * v_6;
        v_80 = v_79 + v_12;
        // String: 32-bit index out of range
        v_81 = int(0);
        ...
        v_88 = v_84 || v_87;
        // String: X index out of bounds
        int v_99 = int(v_80); // LEA into param2
        v_89 = float(texelFetch(u_param2, ivec2((int(v_99) + u_param2_offset) % u_param2_tileW, (int(v_99) + u_param2_offset) / u_param2_tileW), 0).r);
        v_90 = v_78 * v_89;
        v_91 = v_33 + v_90;
        v_92 = int(1);
        v_93 = v_32 + v_92;
    ...
    v_36 = i64_ge(v_10, v_35);
    v_37 = uvec2(2147483647u, 0u);
    v_38 = i64_le(v_10, v_37);
    v_39 = v_36 && v_38;
    // String: 32-bit index out of range
    v_40 = i64_to_i32(v_10);
    v_41 = int(0);
    v_42 = _idx >= v_41;
    v_43 = _idx < v_40;
    v_44 = v_42 && v_43;
    ...
    v_50 = v_44 || v_49;
    // String: X index out of bounds
    int v_100 = int(_idx); // LEA into param4
    v_51 = uvec2(2147483648u, 4294967295u);
    v_52 = i64_ge(v_9, v_51);
    v_53 = uvec2(2147483647u, 0u);
    v_54 = i64_le(v_9, v_53);
    v_55 = v_52 && v_54;
    // String: 32-bit index out of range
    v_56 = i64_to_i32(v_9);
    v_57 = int(0);
    ...
    v_66 = v_60 || v_65;
    // String: X index out of bounds
    int v_101 = int(v_12); // LEA into param3
    v_67 = float(texelFetch(u_param3, ivec2((int(v_101) + u_param3_offset) % u_param3_tileW, (int(v_101) + u_param3_offset) / u_param3_tileW), 0).r);
    v_68 = v_33 + v_67;
    tf_out_4 = v_68;
    return;
}
