...
// Time: 2026-03-24T00:45:14.3140000Z
...
void main() {
    ...
    int v_65 = 0;
    int v_66 = 0;
    // v_67 = buffer alias for param1
    v_2 = uvec2(0u);
    // v_68 = buffer alias for param2
    v_3 = uvec2(0u);
    v_4 = int(0);
    ...
    int v_69 = int(v_4); // LEA into param2
    v_15 = int(texelFetch(u_param2, ivec2((int(v_69) + u_param2_offset) % u_param2_tileW, (int(v_69) + u_param2_offset) / u_param2_tileW), 0).r);
    v_16 = float(0.0);
    v_17 = false;
    v_18 = int(0);
    v_19 = uvec2(2147483648u, 4294967295u);
    v_20 = i64_ge(v_3, v_19);
    v_21 = uvec2(2147483647u, 0u);
    v_22 = i64_le(v_3, v_21);
    v_23 = v_20 && v_22;
    v_24 = i64_to_i32(v_3);
    v_25 = int(0);
    v_26 = v_24 == v_25;
    ...
    for (int _loop0 = 0; _loop0 < 100000; _loop0++) {
        ...
        v_39 = v_35 || v_38;
        // String: X index out of bounds
        int v_70 = int(v_31); // LEA into param2
        v_40 = int(texelFetch(u_param2, ivec2((int(v_70) + u_param2_offset) % u_param2_tileW, (int(v_70) + u_param2_offset) / u_param2_tileW), 0).r);
        v_41 = int(25);
        v_42 = v_40 <= v_41;
        if (!v_42) {
            v_43 = true;
    ...
    v_46 = i64_ge(v_2, v_45);
    v_47 = uvec2(2147483647u, 0u);
    v_48 = i64_le(v_2, v_47);
    v_49 = v_46 && v_48;
    // String: 32-bit index out of range
    v_50 = i64_to_i32(v_2);
    v_51 = int(0);
    ...
    v_60 = v_54 || v_59;
    // String: X index out of bounds
    int v_71 = int(_idx); // LEA into param1
    v_61 = float(-v_27);
    v_62 = v_44 ? v_61 : v_27;
    tf_out_1 = v_62;
    return;
