...
// Time: 2026-03-24T00:45:10.5150000Z
...
void main() {
    ...
    uvec2 v_7 = uvec2(0u);
    // v_8 = buffer alias for param3
    uvec2 v_9 = uvec2(0u);
    uvec2 v_10;
    v_10 = uvec2(2147483648u, 4294967295u);
    bool v_11 = i64_ge(v_9, v_10);
    uvec2 v_12;
    v_12 = uvec2(2147483647u, 0u);
    bool v_13 = i64_le(v_9, v_12);
    bool v_14 = v_11 && v_13;
    // String: 32-bit index out of range
    int v_15 = i64_to_i32(v_9);
    int v_16;
    v_16 = int(0);
    bool v_17 = _idx >= v_16;
    bool v_18 = _idx < v_15;
    ...
    int v_26 = int(_idx); // LEA into param3
    uvec2 v_27;
    v_27 = uvec2(2147483648u, 4294967295u);
    bool v_28 = i64_ge(v_5, v_27);
    uvec2 v_29;
    v_29 = uvec2(2147483647u, 0u);
    bool v_30 = i64_le(v_5, v_29);
    bool v_31 = v_28 && v_30;
    // String: 32-bit index out of range
    int v_32 = i64_to_i32(v_5);
    int v_33;
    v_33 = int(0);
    bool v_34 = _idx >= v_33;
    bool v_35 = _idx < v_32;
    ...
    bool v_42 = v_36 || v_41;
    // String: X index out of bounds
    int v_43 = int(_idx); // LEA into param1
    float v_44;
    v_44 = float(texelFetch(u_param1, ivec2((int(v_43) + u_param1_offset) % u_param1_tileW, (int(v_43) + u_param1_offset) / u_param1_tileW), 0).r);
    int v_45 = _idx % v_3;
    uvec2 v_46;
    v_46 = uvec2(2147483648u, 4294967295u);
    bool v_47 = i64_ge(v_7, v_46);
    uvec2 v_48;
    v_48 = uvec2(2147483647u, 0u);
    bool v_49 = i64_le(v_7, v_48);
    bool v_50 = v_47 && v_49;
    // String: 32-bit index out of range
    int v_51 = i64_to_i32(v_7);
    int v_52;
    v_52 = int(0);
    bool v_53 = v_45 >= v_52;
    bool v_54 = v_45 < v_51;
    ...
    bool v_61 = v_55 || v_60;
    // String: X index out of bounds
    int v_62 = int(v_45); // LEA into param2
    float v_63;
    v_63 = float(texelFetch(u_param2, ivec2((int(v_62) + u_param2_offset) % u_param2_tileW, (int(v_62) + u_param2_offset) / u_param2_tileW), 0).r);
    float v_64 = v_44 * v_63;
    tf_out_3 = v_64;
}
