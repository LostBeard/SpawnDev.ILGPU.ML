...
// Time: 2026-03-24T00:45:13.8970000Z
...
void main() {
    ...
    int v_58 = 0;
    int v_59 = 0;
    // v_60 = buffer alias for param1
    v_2 = uvec2(0u);
    // v_61 = buffer alias for param2
    v_3 = uvec2(0u);
    v_4 = int(0);
    v_5 = uvec2(2147483648u, 4294967295u);
    v_6 = i64_ge(v_3, v_5);
    v_7 = uvec2(2147483647u, 0u);
    v_8 = i64_le(v_3, v_7);
    v_9 = v_6 && v_8;
    ...
    int v_62 = int(v_4); // LEA into param2
    v_15 = int(texelFetch(u_param2, ivec2((int(v_62) + u_param2_offset) % u_param2_tileW, (int(v_62) + u_param2_offset) / u_param2_tileW), 0).r);
    v_16 = float(0.0);
    v_17 = int(0);
    v_18 = uvec2(2147483648u, 4294967295u);
    v_19 = i64_ge(v_3, v_18);
    v_20 = uvec2(2147483647u, 0u);
    v_21 = i64_le(v_3, v_20);
    v_22 = v_19 && v_21;
    v_23 = i64_to_i32(v_3);
    v_24 = int(0);
    v_25 = v_23 == v_24;
    ...
    for (int _loop0 = 0; _loop0 < 100000; _loop0++) {
        ...
        v_54 = v_50 || v_53;
        // String: X index out of bounds
        int v_63 = int(v_46); // LEA into param2
        v_55 = int(texelFetch(u_param2, ivec2((int(v_63) + u_param2_offset) % u_param2_tileW, (int(v_63) + u_param2_offset) / u_param2_tileW), 0).r);
        v_56 = float(v_55);
        v_57 = v_27 + v_56;
        v_58 = int(1);
        v_59 = v_26 + v_58;
    ...
    v_29 = uvec2(2147483648u, 4294967295u);
    v_30 = i64_ge(v_2, v_29);
    v_31 = uvec2(2147483647u, 0u);
    v_32 = i64_le(v_2, v_31);
    v_33 = v_30 && v_32;
    // String: 32-bit index out of range
    v_34 = i64_to_i32(v_2);
    v_35 = int(0);
    ...
    v_44 = v_38 || v_43;
    // String: X index out of bounds
    int v_64 = int(_idx); // LEA into param1
    tf_out_1 = v_27;
    return;
}
