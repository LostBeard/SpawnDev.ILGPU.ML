...
// Time: 2026-03-24T00:45:19.7770000Z
...
void main() {
    ...
    int v_53 = 0;
    int v_54 = 0;
    // v_55 = buffer alias for param1
    v_5 = uvec2(0u);
    // v_56 = buffer alias for param2
    v_6 = uvec2(0u);
    v_7 = _idx / v_4;
    v_8 = _idx % v_4;
    v_9 = float(0.0);
    ...
    v_12 = v_11 + v_8;
    v_13 = int(0);
    v_14 = uvec2(2147483648u, 4294967295u);
    v_15 = i64_ge(v_5, v_14);
    v_16 = uvec2(2147483647u, 0u);
    v_17 = i64_le(v_5, v_16);
    v_18 = v_15 && v_17;
    v_19 = i64_to_i32(v_5);
    v_20 = int(0);
    v_21 = v_19 == v_20;
    ...
    for (int _loop0 = 0; _loop0 < 100000; _loop0++) {
        ...
        int v_57 = int(v_42); // LEA into param1
        v_51 = float(texelFetch(u_param1, ivec2((int(v_57) + u_param1_offset) % u_param1_tileW, (int(v_57) + u_param1_offset) / u_param1_tileW), 0).r);
        v_52 = v_23 + v_51;
        v_53 = int(1);
        v_54 = v_22 + v_53;
        v_22 = v_54;
    ...
    v_26 = i64_ge(v_6, v_25);
    v_27 = uvec2(2147483647u, 0u);
    v_28 = i64_le(v_6, v_27);
    v_29 = v_26 && v_28;
    // String: 32-bit index out of range
    v_30 = i64_to_i32(v_6);
    v_31 = int(0);
    ...
    v_40 = v_34 || v_39;
    // String: X index out of bounds
    int v_58 = int(_idx); // LEA into param2
    tf_out_2 = v_23;
    return;
}
