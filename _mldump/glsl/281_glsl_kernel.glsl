...
// Time: 2026-03-24T00:44:53.3790000Z
...
void main() {
    ...
    int v_12 = v_11 + v_4;
    uvec2 v_13;
    v_13 = uvec2(2147483648u, 4294967295u);
    bool v_14 = i64_ge(v_6, v_13);
    uvec2 v_15;
    v_15 = uvec2(2147483647u, 0u);
    bool v_16 = i64_le(v_6, v_15);
    bool v_17 = v_14 && v_16;
    // String: 32-bit index out of range
    int v_18 = i64_to_i32(v_6);
    int v_19;
    v_19 = int(0);
    bool v_20 = _idx >= v_19;
    bool v_21 = _idx < v_18;
    ...
    int v_29 = int(_idx); // LEA into param1
    uvec2 v_30;
    v_30 = uvec2(2147483648u, 4294967295u);
    bool v_31 = i64_ge(v_6, v_30);
    uvec2 v_32;
    v_32 = uvec2(2147483647u, 0u);
    bool v_33 = i64_le(v_6, v_32);
    bool v_34 = v_31 && v_33;
    // String: 32-bit index out of range
    int v_35 = i64_to_i32(v_6);
    int v_36;
    v_36 = int(0);
    bool v_37 = _idx >= v_36;
    bool v_38 = _idx < v_35;
    ...
    bool v_45 = v_39 || v_44;
    // String: X index out of bounds
    int v_46 = int(_idx); // LEA into param1
    float v_47;
    v_47 = float(texelFetch(u_param1, ivec2((int(v_46) + u_param1_offset) % u_param1_tileW, (int(v_46) + u_param1_offset) / u_param1_tileW), 0).r);
    uvec2 v_48;
    v_48 = uvec2(2147483648u, 4294967295u);
    bool v_49 = i64_ge(v_8, v_48);
    uvec2 v_50;
    v_50 = uvec2(2147483647u, 0u);
    bool v_51 = i64_le(v_8, v_50);
    bool v_52 = v_49 && v_51;
    // String: 32-bit index out of range
    int v_53 = i64_to_i32(v_8);
    int v_54;
    v_54 = int(0);
    bool v_55 = v_12 >= v_54;
    bool v_56 = v_12 < v_53;
    ...
    bool v_63 = v_57 || v_62;
    // String: X index out of bounds
    int v_64 = int(v_12); // LEA into param2
    float v_65;
    v_65 = float(texelFetch(u_param2, ivec2((int(v_64) + u_param2_offset) % u_param2_tileW, (int(v_64) + u_param2_offset) / u_param2_tileW), 0).r);
    float v_66 = v_47 - v_65;
    float v_67;
    v_67 = float(exp(v_66));
    uvec2 v_68;
    v_68 = uvec2(2147483648u, 4294967295u);
    bool v_69 = i64_ge(v_10, v_68);
    uvec2 v_70;
    v_70 = uvec2(2147483647u, 0u);
    bool v_71 = i64_le(v_10, v_70);
    bool v_72 = v_69 && v_71;
    // String: 32-bit index out of range
    int v_73 = i64_to_i32(v_10);
    int v_74;
    v_74 = int(0);
    bool v_75 = v_12 >= v_74;
    bool v_76 = v_12 < v_73;
    ...
    bool v_83 = v_77 || v_82;
    // String: X index out of bounds
    int v_84 = int(v_12); // LEA into param3
    float v_85;
    v_85 = float(texelFetch(u_param3, ivec2((int(v_84) + u_param3_offset) % u_param3_tileW, (int(v_84) + u_param3_offset) / u_param3_tileW), 0).r);
    float v_86 = v_67 / v_85;
    tf_out_1 = v_86;
}
