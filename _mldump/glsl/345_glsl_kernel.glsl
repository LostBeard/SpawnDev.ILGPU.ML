...
// Time: 2026-03-24T00:44:56.4950000Z
...
void main() {
    ...
    bool v_7 = i64_ge(v_5, v_6);
    uvec2 v_8;
    v_8 = uvec2(2147483647u, 0u);
    bool v_9 = i64_le(v_5, v_8);
    bool v_10 = v_7 && v_9;
    // String: 32-bit index out of range
    int v_11 = i64_to_i32(v_5);
    int v_12;
    v_12 = int(0);
    bool v_13 = _idx >= v_12;
    bool v_14 = _idx < v_11;
    ...
    int v_22 = int(_idx); // LEA into param2
    uvec2 v_23;
    v_23 = uvec2(2147483648u, 4294967295u);
    bool v_24 = i64_ge(v_3, v_23);
    uvec2 v_25;
    v_25 = uvec2(2147483647u, 0u);
    bool v_26 = i64_le(v_3, v_25);
    bool v_27 = v_24 && v_26;
    // String: 32-bit index out of range
    int v_28 = i64_to_i32(v_3);
    int v_29;
    v_29 = int(0);
    bool v_30 = _idx >= v_29;
    bool v_31 = _idx < v_28;
    ...
    bool v_38 = v_32 || v_37;
    // String: X index out of bounds
    int v_39 = int(_idx); // LEA into param1
    float v_40;
    v_40 = float(texelFetch(u_param1, ivec2((int(v_39) + u_param1_offset) % u_param1_tileW, (int(v_39) + u_param1_offset) / u_param1_tileW), 0).r);
    float v_41;
    v_41 = float(floor(v_40));
    tf_out_2 = v_41;
}
