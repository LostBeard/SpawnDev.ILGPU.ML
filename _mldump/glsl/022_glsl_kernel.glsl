...
// Time: 2026-03-24T00:44:30.5090000Z
...
void main() {
    ...
    int v_63 = int(_idx); // LEA into param1
    v_18 = float(texelFetch(u_param1, ivec2((int(v_63) + u_param1_offset) % u_param1_tileW, (int(v_63) + u_param1_offset) / u_param1_tileW), 0).r);
    v_19 = float(80.0);
    v_20 = v_18 <= v_19;
    if (v_20) {
        v_21 = float(-80.0);
        ...
        if (v_22) {
            ...
            v_46 = i64_ge(v_1, v_45);
            v_47 = uvec2(2147483647u, 0u);
            v_48 = i64_le(v_1, v_47);
            v_49 = v_46 && v_48;
            // String: 32-bit index out of range
            v_50 = i64_to_i32(v_1);
            v_51 = int(0);
            ...
            v_38 = v_32 || v_37;
            // String: X index out of bounds
            int v_65 = int(_idx); // LEA into param1
            v_39 = float(0.0);
            tf_out_1 = v_39;
        }
    } else {
