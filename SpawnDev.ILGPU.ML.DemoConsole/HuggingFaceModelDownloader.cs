...
public static class HuggingFaceModelDownloader
{
    private static readonly (string RepoId, string FileName, string LocalDir)[] DemoModels = new[]
    {
        ...
        // Detection
        ("salim4n/yolov8n-detect-onnx", "yolov8n-onnx-web/yolov8n.onnx", "yolov8n"),
    ...
    private static readonly (string Url, string LocalDir, string FileName)[] DirectModels = new[]
    {
        ...
        ("https://storage.googleapis.com/mediapipe-models/face_detector/blaze_face_short_range/float16/latest/blaze_face_short_range.tflite", "blaze-face", "model.tflite"),
        ("https://storage.googleapis.com/mediapipe-models/image_classifier/efficientnet_lite0/float32/latest/efficientnet_lite0.tflite", "efficientnet-lite0", "model.tflite"),
    };
